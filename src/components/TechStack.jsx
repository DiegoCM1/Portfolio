...
const TechStack = () => {
  return (
    <section className="pt-2">
      ...
      <div className="flex flex-wrap md:justify-start md:gap-4 text-3xl md:text-4xl">
        {/* Individual Tech Item */}
        <div className="flex flex-col items-center m-1 w-20 h-20 md:w-24 md:h-24 justify-center">
